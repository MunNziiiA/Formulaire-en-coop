...
function CreerRadio() {
  document.getElementById('radio').innerHTML += '<div id="reponse'+monId+'"><input type="radio"><input type="text">'+
  								'<input onclick="SupprimerRadio(\'reponse'+monId+'\')" type="button" value="Supprimer">'+'<br></div>';
